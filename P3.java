...
Assume you've been hired as a consultant to detect fake data sets in a company's database. Using this [Wikipedia article](http://en.wikipedia.org/wiki/Benford%27s_law) as a reference, write a program that helps you figure out which data set is most likely fake and which is most likely real.
	...
	public void getPercent(ArrayList<Integer> x, double[] y) {
	...
	public void checkValid(double[] x) {
		for (int i = 0; i <= x.length - 2; i++) {
			System.out.print(x[i] + " ");
			if (x[i] < x[i+1]) {
				System.out.print("<<This invalidates this data set>> ");
			}
			if (i == x.length - 2) {
				System.out.print(x[i]);
			}
